...
: when{   ( -- orig end-sys ) postpone if end{ postpone else end{ postpone then end } } ; immediate
: when{}  ( -- orig end-sys ) postpone 0= postpone if end{ postpone then end } ; immediate
: }when end ; immediate
: otherwise{ end{ }end ; immediate
: of{     ( -- orig end-sys ) postpone over postpone = postpone if postpone drop end{ postpone else end{ postpone then end } } ; immediate
: }of end ; immediate
: of{}    ( -- orig end-sys ) postpone of{ postpone }of ; immediate
