...
\ The implmentation details are placed into the separate wordlist "support-c-state"
...
forth-wl-new exch-current
  : support-c-state support-c-state ; \ just a synonym in the "forth-wl-new" wordlist.
exch-current drop
